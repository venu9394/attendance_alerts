...
//	alert(val);
	...
	document.getElementById("actualcostbox").checked = false;
	...
	document.getElementById("renttype").value=val;
	if(val=="rent"){
	...
	}else if(val=="ownhousewithproperty"){
		document.getElementById("house1").style.display='';
		document.getElementById("house2").style.display='';
		document.getElementById("house3").style.display='';
	}else{
...
function  lta_drop(){
	 ...
	 var val=document.getElementById("lta").value;
		...
		document.getElementById("place2_2").value='';
		document.getElementById("employee_lta_2").value='';
		document.getElementById("it_select_relation").value='select';
		document.getElementById("it_select_relation_2").value='select';
		document.getElementById("it_select_transport").value='Select';
		document.getElementById("it_select_transport1").value='Select';
		
		document.getElementById("lta_estimated_amount_1").value='';
		document.getElementById("lta_estimated_amount_2").value='';
		document.getElementById("lta_actual_amount_1").value='';
		document.getElementById("lta_actual_amount_2").value='';
...
function employee()  {
	...
	document.getElementById("emp_pan").value='';
...
function section80DDB(val) {
	...
	if(val.value=="80DDB_limit1"){
		 ...
		 document.getElementById("80DDB_1").innerHTML = "<font size='1px' color='red'>Lower of Rs.1,00,000 or the amount actually paid</font>";
		  document.getElementById("80ddb_treatment_estimate").readOnly=false;
		 document.getElementById("80ddb_treatment_estimate").focus();
...
function validate2(){
		...
		try{
			var ary=['80d_medical_estimate','80dd_handicapped_estimate','80ddb_treatment_estimate','80u_disability_estimate','80e_eduloan_estimate','80cgg_rgsavings_estimate','80tta_deposit_estimate','donation_estimate'];
			for(var i=0 ; i<ary.length ; i++){
...
/*80ee*/
function section80ee(val) {
	    //alert(1);
		var CkBox= document.getElementById("chkbox_2").checked;
		var loan= document.getElementById("loanamount").value;
		var date_2= document.getElementById("datepicker").value;
		var _actualcost= document.getElementById("actualcost").value;
		document.getElementById("80ee_interestedu_estimate").value=0;
		document.getElementById("80ee_interestedu_estimate").readOnly=true;
		
	if( CkBox){
		//alert(2); //FirstLoan
		document.getElementById("FirstLoan").style.display='';
		 if(eval(loan)<=3500000 && eval(loan)>0 && eval(_actualcost)<=5000000 && eval(_actualcost)>=0){
		document.getElementById("80ee_interestedu_estimate").readOnly=false;
	   }else{
		   document.getElementById("FirstLoan").style.display='';
	   }
		...
		document.getElementById("80ee_interestedu_estimate").value=0;
		document.getElementById("80ee_interestedu_estimate").readOnly=true;
		document.getElementById("FirstLoan").style.display='none';
		document.getElementById("actualcost").value=0;
	}
}   // IF Close
...
function validate5(){
		...
		try{
			var ary=['lta_estimate','lta_estimated_amount_1','lta_estimated_amount_2','muncipaltaxes'];
			for(var i=0 ; i<ary.length ; i++){
...
/* let out property*/
 function letout(){
	 ...
	 if( eval(document.getElementById("propertyincome").value)>0 ){
		 
		 document.getElementById("muncipaltaxes").readOnly=false;
		 
	 }else{
		 document.getElementById("muncipaltaxes").readOnly=true;
