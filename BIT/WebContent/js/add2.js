...
//	alert(tableID)
	...
	var Field6="0";
	 ...
	 if(tableID=="dataTable1"){
	        ...
	        Field1 = document.getElementById("FF0010").value;
			Field2 = document.getElementById("FF0011").value;
			Field3 = document.getElementById("FF0012").value;
			Field4 = document.getElementById("FF0013").value;
	        Field5 = document.getElementById("FF0014").value;	
	        Field6 = document.getElementById("FF0015").value;	
		   }
		...
		// $("#dataTable1").empty();
		   ...
		   //B.POLICYNO, B.FOR_RELATION, B.CITIZEN, B.POLICY_AMOUNT, B.TOTAL_PREMIUM, B.FINAL_TOTAL
		   
		    Field1 = tableID1.POLICYNO;
			Field2 = tableID1.FOR_RELATION;;
			Field3 = tableID1.CITIZEN;;
			Field4 = tableID1.POLICY_AMOUNT;
			Field5 = tableID1.TOTAL_PREMIUM;
		    
	       
	        document.getElementById("FF0010").value=Field1;
			document.getElementById("FF0011").value=Field2;
			document.getElementById("FF0012").value=Field3;
			document.getElementById("FF0013").value=Field4;
			document.getElementById("FF0014").value=Field5;
