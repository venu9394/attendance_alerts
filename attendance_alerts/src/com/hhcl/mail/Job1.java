...
public class Job1 implements Job { 
	...
	public void execute (JobExecutionContext context)  throws JobExecutionException {
		...
		System.out.println( "Mail Bone Cp Connection Status" +con);
		...
		try {
		      ...
		      FETCHQUERY=prop.getProperty("FETCHQUERY_mail");
			  INSERTQURY=prop.getProperty("INSERTQURY_mail");
			  UPDATEQUEY=prop.getProperty("UPDATEQUEY_mail");
		...
		try {
          ...
          System.out.println(Flag + "E-mail - exuFlag  at Job1.java" + Flag);
