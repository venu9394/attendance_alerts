...
public static void main(String[] args) {
	...
	//************************************************
		...
		htmlboddy.append(" <th colspan='10' class='title-txt'>Your Leave Balance Report of  <B>"+ map1.get("EMPLEAVBAL_YEAR"+ID) +"  </B> </th>   ");   // Leave EMPLEAVBAL_YEAR  
		htmlboddy.append(" </tr>   ");
		htmlboddy.append(" <tr>   ");
		htmlboddy.append(" <th colspan='2'>Leave Type</th>   ");
		htmlboddy.append(" <th colspan='2'>Quota</th>   ");
		htmlboddy.append(" <th colspan='2'>Used</th>   ");
		htmlboddy.append(" <th colspan='2'>Deducted</th>   ");
		...
		htmlboddy.append(map1.get("EMPLEAVBAL_"+ID).toString() );
			...
			htmlboddy.append(" <tr>   ");
			htmlboddy.append(" <td colspan='10'> No Data , Please contact concern department </td> ");
			htmlboddy.append(" </tr>   ");
		}
		/*
		htmlboddy.append(" <tr>   ");
		...
		*/
		...
		htmlboddy.append(" <td colspan='1'> &nbsp; &nbsp;&nbsp; </td>   ");
